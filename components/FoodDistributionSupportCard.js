...
function FoodDistributionSupportCard() {
  ...
  return (
    <Card backgroundImageSource="/images/FoodDistribution.jpg"  backgroundImageAltText="Food Distribution Support Card Provide free food boxes for hungry families">
